...
import com.mahmutalperenunal.flagquiz.R
import com.mahmutalperenunal.flagquiz.database.FlagsDao
import com.mahmutalperenunal.flagquiz.databinding.FragmentQuizBinding
import com.mahmutalperenunal.flagquiz.model.FlagsModel
    ...
    private fun answerControl(button: Button) {
        ...
        if (clickedOption == correctAnswer) {
            ...
            when (correctAnswer) {
                ...
                fragmentQuizBinding.buttonA.text -> fragmentQuizBinding.buttonA.setBackgroundColor(
                    Color.GREEN
                )

                fragmentQuizBinding.buttonB.text -> fragmentQuizBinding.buttonB.setBackgroundColor(
                    Color.GREEN
                )

                fragmentQuizBinding.buttonC.text -> fragmentQuizBinding.buttonC.setBackgroundColor(
                    Color.GREEN
                )

                fragmentQuizBinding.buttonD.text -> fragmentQuizBinding.buttonD.setBackgroundColor(
                    Color.GREEN
                )
